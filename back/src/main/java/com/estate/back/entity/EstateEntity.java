...
public class EstateEntity {
    ...
    private Double monthRatio40;    // 40m2 이하 전세가 대비 월세 보증금 비율
    private Double monthRatio4060;  // 40m2 초과 60m2 이하 전세가 대비 월세 보증금 비율
    private Double monthRatio6085;  // 60m2 초과 85m2 이하 전세가 대비 월세 보증금 비율
    private Double monthRatio85;    // 85m2 초과 전세가 대비 월세 보증금 비율
